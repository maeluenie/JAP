          ...
          <v-card>
            ...
            <v-card class="mx-8 my-8 py-2">
                <v-btn :ripple="false" text color="natural dark-grey" id="background-hover">
                  ...
                  <v-btn :ripple="false" text color="primary darken-3" id="no-background-hover" @click="AP4();">
                  ...
                  <v-col cols="1" sm="1" md="12">
                    ...
                    ></v-textarea>
                      ...
                      <v-col class="text-right">
                        ...
                        <v-btn align="end" color="primary darken-3" @click="AP4();"> 
                          Next
                        </v-btn>
                      </v-col>
                      </v-row>
    ...
    <v-card class="mx-4 my-2 py-2">
      ...
      <v-form class="mx-8 mt-2 align-content-center">
        ...
        <v-row>
          <v-col cols="1" sm="1" md="12">
            ...
            ></v-textarea>
              ...
              <v-col class="text-right">
                <v-btn align="end" color="natural dark-grey" @click="AP3();">  
                  Back
                </v-btn>
        ...
        >
          ...
          <!-- this is the container of the overview of the form dialog for organization form -->
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              color="primary darken-2"
              class="ml-1 mr-4 my-2"
          ...
          <v-card>
            <v-toolbar dark color="primary">
              ...
              <v-toolbar-title>Edit form for {{ this.jobDetails.jobName }} </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-items>
                <v-btn dark text @click="dialog5 = false"> Submit </v-btn>
                <!-- this line must link a function to submit the data to the database -->
              </v-toolbar-items>
            </v-toolbar>
            <v-card class="mx-6 my-4" outlined color="transparent">
        ...
        >
          ...
          <v-card>
            <v-toolbar dark color="primary">
              ...
              <v-spacer></v-spacer>
              <v-toolbar-items>
                <v-btn dark text @click="dialog6 = false"> Submit </v-btn>
                <!-- this line must link a function to submit the data to the database -->
              </v-toolbar-items>
            </v-toolbar>
            <v-card class="mx-6 my-4" outlined color="transparent">
        ...
        >
          ...
          <v-card>
            <v-toolbar dark color="primary">
              ...
              <v-spacer></v-spacer>
              <v-toolbar-items>
                <v-btn dark text @click="dialog7 = false"> Submit </v-btn>
                <!-- this line must link a function to submit the data to the database -->
              </v-toolbar-items>
            </v-toolbar>
            <v-card class="mx-6 my-4" outlined color="transparent">
                ...
                <v-row>
                  ...
                  <v-col cols="1" sm="1" md="12">
                    ...
                    <v-col class="text-right">
                      ...
                      <!-- pack into json send through API -->
                      <v-btn align="end" color="primary darken-3" @click="dialog7 = false"> 
                        Submit
                      </v-btn>
                    </v-col>
                  </v-col>
