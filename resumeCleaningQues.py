...
"""THIS FILE NEED TO:
    1. CLEANED TXT FILES AND OVERWRITE THE TXT FILE MOVE TO TxtQuesCleaned DIRECTORY"""

TextPath = '/root/Filesys/TxtQuesUncleaned/'
CleanedPath = '/root/Filesys/TxtQuesCleaned/'
